...
int main(int argc, char** argv, char** envp) {
    ...
    PAL_HANDLE in = NULL;
    ret = DkStreamOpen(FILE_URI, PAL_ACCESS_RDONLY, /*share_flags=*/0, /*create=*/PAL_OPEN_EXISTING,
                       /*options=*/0, &in);
    if (ret < 0) {
    ...
    PAL_HANDLE del = NULL;
    ret = DkStreamOpen(FILE_URI, PAL_ACCESS_RDWR, /*share_flags=*/0, /*create=*/PAL_OPEN_EXISTING,
                       /*options=*/0, &del);
